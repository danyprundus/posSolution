...
function calcTotals(){
    ...
    $('tr.item').each(function(){
        ...
        totalTax += parseFloat(price * quantity * itemTax/100) > 0 ? parseFloat(price * quantity * taxValue/100) : 0;
...
function cloneRow(in_tbl_name)
{
    ...
    var strHtml4 = '<div class="form-group">{!! Form::input("number","quantity",null, ["class" => "form-control input-sm calcEvent quantity", "id"=>"quantity" , "required", "step" => "any", "min" => "1"]) !!}</div> ';
    td4.innerHTML = strHtml4.replace(/!count!/g,count);
    // create table cell 5
    var td5 = document.createElement("td");
    var strHtml5 = '<div class="form-group">{!! Form::input("number","price",null, ["class" => "form-control input-sm calcEvent price", "id"=>"price", "required","step" => "any", "min" => "1"]) !!}</div> ';
    td5.innerHTML = strHtml5.replace(/!count!/g,count);
    // create table cell 6
    var td6 = document.createElement("td");
    var strHtml6 = '<div class="form-group">{!! Form::customSelect("tax",$taxes,null, ["class" => "form-control input-sm calcEvent tax", "id"=>"tax"]) !!}</div> ';
